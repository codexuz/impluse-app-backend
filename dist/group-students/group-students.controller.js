...
let GroupStudentsController = class GroupStudentsController {
    ...
    async transferStudent(transferStudentDto) {
        return await this.groupStudentsService.transferStudent(transferStudentDto.student_id, transferStudentDto.from_group_id, transferStudentDto.to_group_id);
    }
    async remove(id) {
...
__decorate([
    ...
    Roles(Role.ADMIN, Role.TEACHER),
    ApiOperation({
        summary: "Get all active students for a specific teacher across all their groups",
    }),
    ApiResponse({
        status: 200,
        description: "Return all active students for the teacher with group and student details.",
        type: [GroupStudent],
    }),
    ApiResponse({ status: 401, description: "Unauthorized." }),
    __param(0, Param("teacherId")),
...
__decorate([
    ...
    ApiOperation({
        ...
        description: "Removes student from current group and adds them to new group in a single operation.",
    }),
    ApiResponse({
        status: 201,
        ...
        schema: {
            ...
            properties: {
                removed: {
                    type: "object",
                    description: "The student's record from the source group (now with 'removed' status)",
                },
                added: {
                    type: "object",
    ...
    __param(0, Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [TransferStudentDto]),
    __metadata("design:returntype", Promise)
], GroupStudentsController.prototype, "transferStudent", null);
__decorate([
    Delete(":id"),
    Roles(Role.ADMIN, Role.TEACHER),
