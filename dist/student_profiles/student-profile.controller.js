...
let StudentProfileController = class StudentProfileController {
    ...
    getLeaderboardByCoins(limit) {
        ...
        const validLimit = numericLimit && !isNaN(numericLimit) && numericLimit > 0
            ? numericLimit
            : undefined;
    ...
    getLeaderboardByLevel(limit, userId) {
        if (!userId) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], StudentProfileController.prototype, "getLeaderboardByLevel", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], StudentProfileController.prototype, "getUserRankingByLevel", null);
__decorate([
