...
import { IsString, IsNumber, IsUUID, IsOptional, IsBoolean, IsEnum, IsArray, } from "class-validator";
...
__decorate([
    ...
    IsOptional(),
    __metadata("design:type", String)
], CreateLessonContentDto.prototype, "mediaType", void 0);
__decorate([
    ApiProperty({
        example: [
...
], CreateLessonContentDto.prototype, "resources", void 0);
__decorate([
