...
let GroupAssignedLessonsModule = class GroupAssignedLessonsModule {
};
GroupAssignedLessonsModule = __decorate([
    Module({
        imports: [
...
export { GroupAssignedLessonsModule };
//# sourceMappingURL=group_assigned_lessons.module.js.map