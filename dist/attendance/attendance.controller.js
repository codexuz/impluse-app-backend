...
let AttendanceController = class AttendanceController {
    ...
    async getStudentCurrentMonthAttendance(studentId) {
...
__decorate([
    ...
    ApiOperation({
        ...
        description: "Efficiently create attendance records for multiple students. Teacher payment is processed individually for each present student.",
    }),
    ApiResponse({
        status: 201,
...
__decorate([
    ...
    ApiResponse({
        status: 200,
        description: "Returns attendance records for the specified group within the date range.",
    }),
    ApiResponse({
        status: 400,
...
__decorate([
    ...
    ApiResponse({
        status: 200,
        description: "Returns attendance records for the specified student within the date range.",
    }),
    ApiResponse({
        status: 400,
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AttendanceController.prototype, "getStudentCurrentMonthAttendance", null);
