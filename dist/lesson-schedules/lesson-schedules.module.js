...
let LessonSchedulesModule = class LessonSchedulesModule {
};
LessonSchedulesModule = __decorate([
    Module({
        controllers: [LessonSchedulesController],
        providers: [LessonSchedulesService],
    })
], LessonSchedulesModule);
export { LessonSchedulesModule };
//# sourceMappingURL=lesson-schedules.module.js.map