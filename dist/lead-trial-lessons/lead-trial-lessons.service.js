    ...
    async getTrialLessonStats() {
        ...
        const statusStats = await this.trialLessonModel.findAll({
            attributes: [
                "status",
                [
                    this.trialLessonModel.sequelize.fn("COUNT", this.trialLessonModel.sequelize.col("status")),
                    "count",
                ],
            ],
            group: ["status"],
        ...
        const teacherStats = await this.trialLessonModel.findAll({
            attributes: [
                "teacher_id",
                [
                    this.trialLessonModel.sequelize.fn("COUNT", this.trialLessonModel.sequelize.col("teacher_id")),
                    "count",
                ],
            ],
            include: [
