...
export class GroupStudentsController {
    ...
    async create(@Body() createGroupStudentDto: CreateGroupStudentDto): Promise<GroupStudent> {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized.' })
    async findByGroupId(@Param('groupId') groupId: string): Promise<GroupStudent[]> {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized.' })
    async findActiveByGroupId(@Param('groupId') groupId: string): Promise<GroupStudent[]> {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized.' })
    async findByStudentId(@Param('studentId') studentId: string): Promise<GroupStudent[]> {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized.' })
    async countStudentsByTeacher(@Param('teacherId') teacherId: string): Promise<{ count: number }> {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized.' })
    async getStudentsByTeacher(@Param('teacherId') teacherId: string): Promise<GroupStudent[]> {
