...
export class FormsController {
  ...
  findResponsesByForm(@Param('formId', ParseUUIDPipe) formId: string) {
  ...
  findOneResponse(@Param('id', ParseUUIDPipe) id: string) {
  ...
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Response not found' })
  updateResponse(@Param('id', ParseUUIDPipe) id: string, @Body() updateResponseDto: UpdateResponseDto) {
  ...
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Response not found' })
  removeResponse(@Param('id', ParseUUIDPipe) id: string) {
