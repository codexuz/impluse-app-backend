...
export class GroupHomeworksController {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized.' })
    @ApiResponse({ status: 404, description: 'User is not in any group.' })
    async getActiveHomeworksByDate(@Param('userId') userId: string): Promise<any[]> {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized.' })
    async getHomeworkStatusByGroup(@Param('groupId') groupId: string): Promise<GroupHomeworkStatusDto> {
    ...
    @ApiResponse({ status: 401, description: 'Unauthorized.' })
    async getOverallHomeworkStats(@Query('groupId') groupId?: string): Promise<OverallHomeworkStatsDto> {
