...
import { CreateStudentPaymentDto, PaymentStatus, PaymentMethod } from './dto/create-student-payment.dto.js';
...
export class StudentPaymentService {
  ...
  async create(createStudentPaymentDto: CreateStudentPaymentDto): Promise<StudentPayment> {
  ...
  async findByDateRange(startDate: Date, endDate: Date): Promise<StudentPayment[]> {
    return this.studentPaymentModel.findAll({
      where: {
        payment_date: {
  ...
  async update(id: string, updateStudentPaymentDto: UpdateStudentPaymentDto): Promise<StudentPayment> {
  ...
  async updateStatus(id: string, status: PaymentStatus): Promise<StudentPayment> {
    const payment = await this.findOne(id);
   ...
   */
  async calculateStudentPaymentStatus(studentId: string): Promise<StudentPaymentStatusDto> {
