...
export class LessonProgressController {
  ...
  findByStudentAndLesson(
    ...
    return this.lessonProgressService.findByStudentAndLesson(
      studentId,
      lessonId,
    );
  }
  ...
  @ApiOperation({
    summary: "Get detailed lesson progress with sections breakdown",
  })
  @ApiResponse({ status: 200 })
  getDetailedProgress(
    @Param("studentId") studentId: string,
    ...
    return this.lessonProgressService.getProgressByLessonAndStudent(
      studentId,
      lessonId,
    );
  }
  ...
  updateSectionProgress(
    ...
    return this.lessonProgressService.updateSectionProgress(
      studentId,
      lessonId,
      section,
    );
  ...
  updateFromHomeworkSubmission(
    ...
    return this.lessonProgressService.updateProgressFromHomeworkSubmission(
      studentId,
      homeworkId,
      section,
    );
  ...
  @ApiOperation({
    summary: "Get section progress statistics for a specific student",
  })
  @ApiResponse({ status: 200 })
  ...
  @ApiOperation({
    summary: "Get section progress statistics for a specific lesson",
  })
  @ApiResponse({ status: 200 })
  ...
  getTopPerformingStudentsBySection(
    ...
    return this.lessonProgressService.getTopPerformingStudentsBySection(
      section,
      limitNumber,
    );
  }
  ...
  @ApiOperation({
    summary: "Get comprehensive progress report with all statistics",
  })
  @ApiResponse({ status: 200 })
  ...
  getStudentComparisonStats(@Body() body: { student_ids: string[] }) {
    return this.lessonProgressService.getStudentComparisonStats(
      body.student_ids,
    );
  }
  ...
  @Get("student/:studentId/homework-progress")
  @ApiOperation({
    summary:
      "Get homework-based progress for a student across courses, units, and lessons",
  })
  @ApiResponse({ status: 200 })
  getHomeworkProgress(@Param("studentId") studentId: string) {
    return this.lessonProgressService.getHomeworkProgress(studentId);
  }
}
