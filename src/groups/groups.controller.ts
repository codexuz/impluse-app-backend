...
export class GroupsController {
  ...
  @ApiResponse({
    status: 200,
    description: "Return the count of active groups.",
  })
  @ApiResponse({ status: 401, description: "Unauthorized." })
  ...
  @ApiResponse({
    status: 200,
    description: "Return the group with its students.",
    type: Group,
  })
  @ApiResponse({ status: 401, description: "Unauthorized." })
  @ApiResponse({ status: 404, description: "Group not found." })
  ...
  @ApiResponse({
    status: 200,
    description: "Return the group with its teacher.",
    type: Group,
  })
  @ApiResponse({ status: 401, description: "Unauthorized." })
  @ApiResponse({ status: 404, description: "Group not found." })
  ...
  @ApiResponse({
    status: 200,
    description: "Return all groups for the teacher.",
    type: [Group],
  })
  @ApiResponse({ status: 401, description: "Unauthorized." })
  async findByTeacher(
    ...
    return await this.groupsService.findByTeacherId(
      teacherId,
      page ? parseInt(page, 10) : 1,
      limit ? parseInt(limit, 10) : 10,
      query,
  ...
  @ApiResponse({
    status: 200,
    description: "Return all groups for the level.",
    type: [Group],
  })
  @ApiResponse({ status: 401, description: "Unauthorized." })
  async findByLevel(
    ...
    return await this.groupsService.findByLevelId(
      levelId,
      page ? parseInt(page, 10) : 1,
      limit ? parseInt(limit, 10) : 10,
      query,
