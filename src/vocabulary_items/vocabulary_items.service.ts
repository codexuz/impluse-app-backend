...
export class VocabularyItemsService {
  ...
  async create(createVocabularyItemDto: CreateVocabularyItemDto): Promise<VocabularyItem> {
    return this.vocabularyItemModel.create({ ...createVocabularyItemDto });
  }

  async createMany(createVocabularyItemDtos: CreateVocabularyItemDto[]): Promise<VocabularyItem[]> {
  ...
  async update(id: string, updateVocabularyItemDto: UpdateVocabularyItemDto): Promise<VocabularyItem> {
