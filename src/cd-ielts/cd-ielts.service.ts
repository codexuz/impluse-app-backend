...
export class CdIeltsService {
  ...
  async registerForTest(createCdRegisterDto: CreateCdRegisterDto): Promise<CdRegister> {
  ...
  async updateRegistration(id: string, updateCdRegisterDto: UpdateCdRegisterDto): Promise<CdRegister> {
