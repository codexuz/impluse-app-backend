...
export class CdIeltsController {
  ...
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Test not found' })
  updateTest(@Param('id') id: string, @Body() updateCdIeltDto: UpdateCdIeltDto) {
  ...
  findRegistrationsByTest(@Param('testId') testId: string) {
  ...
  findRegistrationsByStudent(@Param('studentId') studentId: string) {
  ...
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Registration not found' })
  updateRegistration(@Param('id') id: string, @Body() updateCdRegisterDto: UpdateCdRegisterDto) {
