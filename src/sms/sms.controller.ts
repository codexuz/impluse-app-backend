...
export class SmsController {
  ...
  @ApiResponse({ status: 200, description: 'Verification SMS sent successfully' })
  @ApiResponse({ status: 400, description: 'Bad request' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiResponse({ status: 200, description: 'Notification SMS sent successfully' })
  @ApiResponse({ status: 400, description: 'Bad request' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiResponse({ status: 200, description: 'Service reinitialized successfully' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  async reinitialize() {
