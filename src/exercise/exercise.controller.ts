...
export class ExerciseController {
  ...
  async create(@Body() createExerciseDto: CreateCompleteExerciseDto): Promise<Exercise> {
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  async findByLessonId(@Param('lessonId') lessonId: string): Promise<Exercise[]> {
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  async findByType(@Param('exerciseType') exerciseType: string): Promise<Exercise[]> {
