...
export class UpdateCompleteExerciseDto extends PartialType(
  CreateCompleteExerciseDto,
) {}

export class UpdateQuestionDto extends PartialType(CreateQuestionDto) {}

export class UpdateCompleteQuestionDto extends PartialType(
  CreateCompleteQuestionDto,
) {}
...
export class UpdateTypingExerciseDto extends PartialType(
  CreateTypingExerciseDto,
) {}
